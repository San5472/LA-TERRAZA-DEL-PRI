...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference("Home.count") do
      post homes_url, params: { home: { desc: @home.desc, direccion: @home.direccion, nombre: @home.nombre } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { desc: @home.desc, direccion: @home.direccion, nombre: @home.nombre } }
