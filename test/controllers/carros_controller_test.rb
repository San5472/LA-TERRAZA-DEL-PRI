...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference("Carro.count") do
      post carros_url, params: { carro: { color: @carro.color, matricula: @carro.matricula, modelo: @carro.modelo } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { color: @carro.color, matricula: @carro.matricula, modelo: @carro.modelo } }
